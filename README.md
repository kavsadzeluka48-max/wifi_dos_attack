...
print("\n**********************************************************************************************")
print("\n* Made In Python                                                                             *")
print("\n* need help? text us on this Gmail: kavsadzeluka48@gmail                                     *")
print("\n* WARNING: DO NOT TRY THIS COMMAND IN PUBLIC OR ON THE HOUSE WIFI WITH NO PERMISION          *")
print("\n* Note: To make this command usable you will need WI-FI Adapter                              *")
print("\n**********************************************************************************************")
